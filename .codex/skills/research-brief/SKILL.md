---
name: research-brief
description: Structured brief on a topic. Orchestrates web search, source assessment,
  and synthesis. The "now synthesise it" follow-up to a raw Web Searcher run. Use
